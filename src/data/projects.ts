...
export const projects: Project[] = [
  ...
  {
    slug: "mater-christi",
    name: "Mater Christi Saúde Integrada",
    kind: "web",
    address: "mater-christi.igorgois.dev",
    kicker: { pt: "100 no Lighthouse", en: "100 on Lighthouse", es: "100 en Lighthouse" },
    category: { pt: "Web · Clínica · SEO local", en: "Web · Clinic · Local SEO", es: "Web · Clínica · SEO local" },
    period: { pt: "2026", en: "2026", es: "2026" },
    description: {
      pt: "Site institucional para uma clínica popular de Petrolina com 16 especialidades, construído sobre um template próprio em Next.js: conteúdo tipado em um único arquivo por clínica, agenda filtrável por dia da semana, WhatsApp com mensagem pré-preenchida por especialidade e profissional, uma página por especialidade para busca local, imagens Open Graph geradas no build, dados estruturados de clínica médica e transições entre páginas com a View Transitions API.",
      en: "Institutional website for a community clinic in Petrolina with 16 specialties, built on my own Next.js template: typed content in a single file per clinic, weekday-filterable schedule, WhatsApp with pre-filled messages per specialty and professional, one page per specialty for local search, build-time Open Graph images, medical-clinic structured data and page transitions with the View Transitions API.",
      es: "Sitio institucional para una clínica popular de Petrolina con 16 especialidades, construido sobre una plantilla propia en Next.js: contenido tipado en un único archivo por clínica, agenda filtrable por día de la semana, WhatsApp con mensaje prellenado por especialidad y profesional, una página por especialidad para búsqueda local, imágenes Open Graph generadas en el build, datos estructurados de clínica médica y transiciones entre páginas con la View Transitions API.",
    },
    result: {
      pt: "Lighthouse 98 mobile e 100 desktop · acessibilidade, boas práticas e SEO 100 · 17 páginas estáticas · demo publicada em 2 dias",
      en: "Lighthouse 98 mobile and 100 desktop · accessibility, best practices and SEO at 100 · 17 static pages · demo shipped in 2 days",
      es: "Lighthouse 98 móvil y 100 escritorio · accesibilidad, buenas prácticas y SEO en 100 · 17 páginas estáticas · demo publicada en 2 días",
    },
    role: {
      pt: "Projeto próprio: pesquisa, design, desenvolvimento, performance e SEO",
      en: "Solo project: research, design, development, performance and SEO",
      es: "Proyecto propio: investigación, diseño, desarrollo, rendimiento y SEO",
    },
    stack: ["Next.js 16", "React 19", "TypeScript", "Tailwind CSS 4", "Vercel", "Playwright"],
    cover: { pt: "/projects/mater-christi/cover.png", en: "/projects/mater-christi/cover.png", es: "/projects/mater-christi/cover.png" },
    gallery: [
      { src: "/projects/mater-christi/01-home.jpg", alt: { pt: "Home com fachada, nota do Google e agendamento pelo WhatsApp", en: "Home with facade, Google rating and WhatsApp booking", es: "Inicio con fachada, nota de Google y cita por WhatsApp" } },
      { src: "/projects/mater-christi/02-especialidades.jpg", alt: { pt: "Especialidades filtráveis por dia da semana", en: "Specialties filterable by weekday", es: "Especialidades filtrables por día de la semana" } },
      { src: "/projects/mater-christi/03-profissionais.jpg", alt: { pt: "Equipe com botão de agendar por profissional", en: "Team with a booking button per professional", es: "Equipo con botón de cita por profesional" } },
      { src: "/projects/mater-christi/04-cartao.jpg", alt: { pt: "Cartão de desconto com mock 3D", en: "Discount card with a 3D mock", es: "Tarjeta de descuento con mock 3D" } },
      { src: "/projects/mater-christi/05-pacotes.jpg", alt: { pt: "Pacotes de terapias multidisciplinares", en: "Multidisciplinary therapy packages", es: "Paquetes de terapias multidisciplinarias" } },
      { src: "/projects/mater-christi/07-especialidade.jpg", alt: { pt: "Página de especialidade com dias de atendimento e equipe", en: "Specialty page with schedule and team", es: "Página de especialidad con horario y equipo" } },
      { src: "/projects/mater-christi/06-contato.jpg", alt: { pt: "Localização com mapa, horários e contato", en: "Location with map, hours and contact", es: "Ubicación con mapa, horarios y contacto" } },
      { src: "/projects/mater-christi/08-mobile.jpg", alt: { pt: "Versão para celular", en: "Mobile version", es: "Versión móvil" } },
    ],
    url: "https://mater-christi.igorgois.dev",
  },
];
